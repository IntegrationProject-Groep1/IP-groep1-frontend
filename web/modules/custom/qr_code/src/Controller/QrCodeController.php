...
<div class="badge-page">
  ...
  <div class="card badge-page-card">
    <div class="badge-page-hd">
      <span class="eyebrow">' . $this->t('Jouw festivalbadge') . '</span>
      <h1>' . $this->t('Scan om in te checken of te betalen.') . '</h1>
      <p>' . $this->t('Deze QR code identificeert je bij alle twaalf podia. Dezelfde scan werkt bij de ingang, de bar en bij elke sessie check-in.') . '</p>
    </div>
